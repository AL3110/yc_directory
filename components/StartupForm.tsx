...
const StartupForm = () => {
  ...
  const { toast } = useToast(); // for pop up notification
  const router = useRouter();
  
  const handleFormSubmit = async (prevState: any, formData: FormData) => { //received by default by the functin assigned as the form action 
    try {
      const formValues = {
      ...
      return { // by default whatever the form action functino returns -> becomes the new state
        ...prevState,
